...
ASSET_PROFILES = {
    'SUI/USDT:USDT': [0.9, 0.010, 0.006],   # Даємо забрати більший тейк
    'XRP/USDT:USDT': [0.8, 0.007, 0.004],   # Короткий стоп і швидкий вхід завдяки мікро-шуму
    'SOL/USDT:USDT': [1.0, 0.008, 0.006],   # Стандартний профіль
    'BTC/USDT:USDT': [1.0, 0.008, 0.006],   # Стандартний профіль
    'ETH/USDT:USDT': [1.0, 0.008, 0.006]    # Стандартний профіль
}
